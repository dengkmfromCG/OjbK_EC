...
public class RvItemTouchCallback extends ItemTouchHelper.Callback {
    ...
    private final AutoPhotoView.PhotoAdapter adapter;
    private final List<Uri> images;//图片经过压缩处理
    private final List<Uri> originImages;//图片没有经过处理，这里传这个进来是为了使原图片的顺序与拖拽顺序保持一致
    private final Context context;

    private final View mDeleteView;


    public RvItemTouchCallback(AutoPhotoView.PhotoAdapter adapter, List<Uri> images, List<Uri> originImages,
