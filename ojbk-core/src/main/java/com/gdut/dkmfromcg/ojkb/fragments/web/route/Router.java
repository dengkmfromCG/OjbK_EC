package com.gdut.dkmfromcg.ojkb.fragments.web.route;
...
import com.gdut.dkmfromcg.ojkb.fragments.web.WebFragmentImpl;
...
public class Router {
    ...
    public final boolean handleWebUrl(WebFragment fragment, String url) {
        ...
        final ProxyFragment topDelegate = fragment.getTopFragment();
