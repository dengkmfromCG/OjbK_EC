...
public class DkmWeChat {
    public static final String APP_ID = DKM.getConfiguration(ConfigType.WE_CHAT_APP_ID);
    public static final String APP_SECRET = DKM.getConfiguration(ConfigType.WE_CHAT_APP_SECRET);
    ...
    private DkmWeChat(){
        final Activity activity = DKM.getConfiguration(ConfigType.ACTIVITY);
