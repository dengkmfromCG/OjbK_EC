package com.gdut.dkmfromcg.net_code.netResquest;

import android.content.Context;
import android.support.annotation.NonNull;


import com.gdut.dkmfromcg.net_code.netResquest.interceptors.CacheInterceptor;
import com.gdut.dkmfromcg.net_code.netResquest.interceptors.CacheInterceptorOffline;
import com.gdut.dkmfromcg.net_code.util.Logger;
...
public final class RestClientBuilder {
    ...
    public final RestClient build() {
        ...
        return new RestClient(mContext, mUrl, PARAMS,
                mBody, mFile,  mDownloadDir, mExtension, mName,okHttpClient);
    }
