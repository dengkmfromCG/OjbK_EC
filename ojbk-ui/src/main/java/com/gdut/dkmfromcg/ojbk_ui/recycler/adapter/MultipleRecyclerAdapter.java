...
import com.gdut.dkmfromcg.ojbk_ui.banner.ad.UrlImageBannerCreator;
    ...
    protected void convert(MultipleViewHolder holder, MultipleItemEntity itemEntity) {
        ...
        switch (holder.getItemViewType()) {
            ...
            case ItemType.BANNER:
                if (!mIsInitBanner) {
                    bannerImages = itemEntity.getField(MultipleFields.BANNERS);
                    final ConvenientBanner<String> convenientBanner = holder.getView(R.id.banner_recycler_item);
                    UrlImageBannerCreator.setDefault(convenientBanner, bannerImages, this);
                    mIsInitBanner = true;
                }
                break;
            default:
